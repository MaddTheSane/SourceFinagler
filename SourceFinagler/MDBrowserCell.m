...
//		NSLog(@"[%@ %@] drawing image", NSStringFromClass([self class]), NSStringFromSelector(_cmd));
		[self.image drawInRect:imageRect fromRect:NSZeroRect operation:NSCompositingOperationSourceOver fraction:(itemIsInvisible ? 0.5 : 1.0) respectFlipped:YES hints:nil];
	}
